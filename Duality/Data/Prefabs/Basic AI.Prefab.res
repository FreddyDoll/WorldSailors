  ...
  <objTree dataType="Struct" type="Duality.GameObject" id="3063359850">
    ...
    <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="1182178349">
      <_items dataType="Array" type="Duality.GameObject[]" id="2074548838" length="4">
        <item dataType="Struct" type="Duality.GameObject" id="1484575679">
          <active dataType="Bool">true</active>
          <children />
          <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="846886015">
            <_items dataType="Array" type="Duality.Component[]" id="1708749614" length="4">
              <item dataType="Struct" type="Duality.Components.Transform" id="1541852897">
                <active dataType="Bool">true</active>
                ...
                <gameobj dataType="ObjectRef">1484575679</gameobj>
              ...
              <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="2953194959">
                <active dataType="Bool">true</active>
              ...
              <item dataType="Struct" type="WorldSailorsDuality.AITarget" id="2331755019">
          ...
          <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="619944288" surrogate="true">
            <header />
            <body>
              <keys dataType="Array" type="System.Object[]" id="1719674805">
                <item dataType="Type" id="1078374134" value="Duality.Components.Transform" />
                <item dataType="Type" id="339905050" value="Duality.Components.Renderers.SpriteRenderer" />
                <item dataType="Type" id="179958806" value="WorldSailorsDuality.AITarget" />
              </keys>
              <values dataType="Array" type="System.Object[]" id="982920008">
                <item dataType="ObjectRef">1541852897</item>
                <item dataType="ObjectRef">2953194959</item>
                <item dataType="ObjectRef">2331755019</item>
              </values>
            </body>
          </compMap>
          <compTransform dataType="ObjectRef">1541852897</compTransform>
          <identifier dataType="Struct" type="System.Guid" surrogate="true">
            <header>
              <data dataType="Array" type="System.Byte[]" id="1609705215">9CgHJgF71kGnlsrn6et9WA==</data>
            </header>
            <body />
          </identifier>
          <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          <name dataType="String">ref_InitialPosition</name>
          <parent dataType="ObjectRef">3063359850</parent>
          <prefabLink />
        </item>
      </_items>
